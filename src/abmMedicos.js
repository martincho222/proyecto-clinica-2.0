  ...
  db.collection("admin").onSnapshot((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      <td><button class= "btn btn-warning"onclick="editar('${doc.id}', '${doc.data().nombre}','${doc.data().apellido}','${doc.data().especialidad}')"><a class="btnEditar" href="#nombre"><i class="far fa-edit"></i></a></button></td>
